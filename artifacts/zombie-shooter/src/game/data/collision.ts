/**
 * data/collision.ts — canonical Rapier collision group constants.
 *
 * This module is the single source of truth for all collision group bitmasks
 * used in the Grudge Warlords engine. Import from here in any file that needs
 * to assign or query Rapier collider groups.
 *
 ...
 *
 * NOTE: CollisionLayers.ts now re-exports from here for backward compatibility.
 * Zero Zustand imports — pure numeric constants.
 */
