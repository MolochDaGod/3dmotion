...
/** Base URL for API requests. Override by setting GRUDGE_API_BASE on the window. */
function apiBase(): string {
  return (typeof window !== "undefined" && (window as Record<string, unknown>).__GRUDGE_API_BASE as string) || "/api";
}
